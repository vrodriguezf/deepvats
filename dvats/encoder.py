...
def get_enc_embs_moirai(
    ...
    if verbose > 0: print("--> get_enc_embs_moirai")
    # Move tensor and model to GPU
    if cpu or not torch.cuda.is_available():
    ...
    forecasts  = predictor.predict(X.input)
    embeddings = forecasts.samples 
    
    if verbose > 0: print("get_enc_embs_moirai | Get Embeddings")
