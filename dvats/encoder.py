...
def show_eval_stats(
    ...
    self.eval_stats_pre     = self.eval_stats_pre   or eval_stats_pre
    self.eval_stats_post    = self.eval_stats_post  or eval_stats_post
    self.mssg.to_path       = self.mssg.to_path     or print_to_path
    self.mssg.path          = self.mssg.path        or print_path
    self.mssg.mode          = self.mssg.mode        or print_mode       
    if (eval_pre):
