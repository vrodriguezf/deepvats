...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'dvats.all': {},
            ...
            'dvats.mplots': { 'dvats.mplots.DistanceMatrix': ('mplots.html#distancematrix', 'dvats/mplots.py'),
                              ...
                              'dvats.mplots.MatrixProfilePlot.plot_interactive': ('mplots.html#plot_interactive', 'dvats/mplots.py'),
                              'dvats.mplots.MatrixProfilePlot.plot_xrange': ('mplots.html#plot_xrange', 'dvats/mplots.py'),
                              'dvats.mplots.MatrixProfilePlot.plot_yrange': ('mplots.html#plot_yrange', 'dvats/mplots.py'),
