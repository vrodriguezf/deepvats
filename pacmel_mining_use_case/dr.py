# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/02_dimensionality_reduction.ipynb (unless otherwise specified).

__all__ = ['fget_UMAP_embeddings', 'fplot_embeddings', 'train_surrogate_model']
