...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'dvats.all': {},
            ...
            'dvats.mplots': { 'dvats.mplots.DistanceMatrix': ('mplots.html#distancematrix', 'dvats/mplots.py'),
                              ...
                              'dvats.mplots.Interpolator': ('mplots.html#interpolator', 'dvats/mplots.py'),
                              'dvats.mplots.Interpolator.__init__': ('mplots.html#__init__', 'dvats/mplots.py'),
                              'dvats.mplots.Interpolator.fit': ('mplots.html#fit', 'dvats/mplots.py'),
                              'dvats.mplots.Interpolator.transform': ('mplots.html#transform', 'dvats/mplots.py'),
                              ...
                              'dvats.mplots.PAATransformer': ('mplots.html#paatransformer', 'dvats/mplots.py'),
                              'dvats.mplots.PAATransformer.__init__': ('mplots.html#__init__', 'dvats/mplots.py'),
                              'dvats.mplots.PAATransformer.fit': ('mplots.html#fit', 'dvats/mplots.py'),
                              'dvats.mplots.PAATransformer.transform': ('mplots.html#transform', 'dvats/mplots.py'),
                              ...
                              'dvats.mplots.find_dominant_window_sizes_list': ( 'mplots.html#find_dominant_window_sizes_list',
                                                                                'dvats/mplots.py'),
                              ...
                              'dvats.mplots.plot_with_dots': ('mplots.html#plot_with_dots', 'dvats/mplots.py'),
                              'dvats.mplots.restore_index': ('mplots.html#restore_index', 'dvats/mplots.py'),
                              'dvats.mplots.show_sequence': ('mplots.html#show_sequence', 'dvats/mplots.py'),
            ...
            'dvats.mstamp': { 'dvats.mstamp.mstamp': ('mstamp.html#mstamp', 'dvats/mstamp.py'),
                              'dvats.mstamp.mstomp': ('mstamp.html#mstomp', 'dvats/mstamp.py'),
                              'dvats.mstamp.stamp_mass': ('mstamp.html#stamp_mass', 'dvats/mstamp.py'),
                              'dvats.mstamp.stamp_mass_pre': ('mstamp.html#stamp_mass_pre', 'dvats/mstamp.py'),
                              'dvats.mstamp.stomp_mass': ('mstamp.html#stomp_mass', 'dvats/mstamp.py'),
                              'dvats.mstamp.stomp_mass_pre': ('mstamp.html#stomp_mass_pre', 'dvats/mstamp.py')},
