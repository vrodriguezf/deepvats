...
# %% auto 0
__all__ = ['ENCODER_EMBS_MODULE_NAME', 'EncoderInput', 'EncoderOptimizer', 'Encoder', 'set_fine_tune_', 'show_eval_stats_',
           'DCAE_torch', 'kwargs_to_gpu_', 'kwargs_to_cpu_', 'get_acts', 'get_acts_moment', 'sure_eval_moment',
           ...
           'get_enc_embs', 'get_enc_embs_set_stride_set_batch_size', 'random_windows', 'windowed_dataset',
           'setup_scheduler', 'prepare_train_and_eval_dataloaders', 'fine_tune_moment_compute_loss_check_sizes_',
           'fine_tune_moment_compute_loss', 'fine_tune_moment_eval_preprocess', 'fine_tune_moment_eval_step_',
           'fine_tune_moment_eval_', 'fine_tune_moment_train_loop_step_', 'fine_tune_moment_train_',
           'fine_tune_moment_single_', 'fine_tune_moment_', 'fine_tune_mvp_compute_loss', 'fine_tune_mvp_eval_step_',
           'fine_tune_mvp_train_loop_step_', 'fine_tune_mvp_train_', 'fine_tune_mvp_single_', 'fine_tune_mvp_',
           'fine_tune_']
...
class EncoderInput:
    ...
    @property
    def size(self):
        if self._update_size and self.data is not None:
    ...
    @property
    def shape(self):
        if self._update_shape and self.data is not None:
            try: 
                self._shape = self.data.shape
            except:
                self._shape = self.data[0].shape
...
class EncoderOptimizer():
    ...
    lr_scheduler_name   : str           = "OneCycleR"
...
def fine_tune_mvp_compute_loss(
    ...
    enc.print("fine_tune_mvp_compute_loss | Not yet implemented")
    raise NotImplementedError("fine_tune_mvp_compute_loss | Not yet implemented")
    #if verbose > 0: ut.print_flush("fine_tune_mvp_compute_loss -->", print_to_path = print_to_path, print_path = print_path, print_mode = print_mode, verbose = verbose, print_time = print_to_path)
    return loss
...
def fine_tune_mvp_eval_step_(
    ...
    #if verbose > 0: ut.print_flush("--> fine_tune_mvp_compute_loss", print_to_path = print_to_path, print_path = print_path, print_mode = print_mode, verbose = verbose, print_time = print_to_path)
    error = "fine_tune_mvp_step_ | Not yet implemented"
    enc.print(error)
...
def fine_tune_mvp_train_(
    ...
    mssg = deepcopy(enc.mssg)
    mssg.initial("fine_tune_mvp_train_")
    #self.print("--> fine_tune_mvp_train_")
    error = "fine_tune_mvp_train_ Not yet implemented"
    mssg.print(error)
    raise NotImplementedError(error)
    #self.print("fine_tune_mvp_train_ -->")
...
def fine_tune_mvp_single_(
    ...
    mssg = deepcopy(enc.mssg)
    mssg.initial("fine_tune_mvp_single_")
    mssg.final()
    error = f"{mssg.function} | Not yet implemented"
    mssg.print(error)
    raise NotImplementedError(error)
