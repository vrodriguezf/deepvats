...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'dvats.all': {},
            ...
            'dvats.mplots': { 'dvats.mplots.DistanceProfile': ('mplots.html#distanceprofile', 'dvats/mplots.py'),
                              'dvats.mplots.DistanceProfile.compute': ('mplots.html#compute', 'dvats/mplots.py'),
                              'dvats.mplots.DistanceProfile.load_data_from_matlab': ( 'mplots.html#load_data_from_matlab',
                                                                                      'dvats/mplots.py'),
                              ...
                              'dvats.mplots.MatrixProfilePlot.compute_similarity_matrix': ( 'mplots.html#compute_similarity_matrix',
                                                                                            'dvats/mplots.py'),
                              ...
                              'dvats.mplots.MatrixProfilePlotCached.compute_similarity_matrix': ( 'mplots.html#compute_similarity_matrix',
                                                                                                  'dvats/mplots.py'),
                              'dvats.mplots.MatrixProfilePlotCached.plot': ('mplots.html#plot', 'dvats/mplots.py'),
