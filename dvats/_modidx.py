...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'dvats.all': {},
            ...
            'dvats.encoder': { 'dvats.encoder.DCAE_torch': ('encoder.html#dcae_torch', 'dvats/encoder.py'),
                               ...
                               'dvats.encoder.Encoder.show_eval_stats_': ('encoder.html#show_eval_stats_', 'dvats/encoder.py'),
                               ...
                               'dvats.encoder.fine_tune_mvp_compute_loss': ('encoder.html#fine_tune_mvp_compute_loss', 'dvats/encoder.py'),
                               'dvats.encoder.fine_tune_mvp_eval_step_': ('encoder.html#fine_tune_mvp_eval_step_', 'dvats/encoder.py'),
                               'dvats.encoder.fine_tune_mvp_single_': ('encoder.html#fine_tune_mvp_single_', 'dvats/encoder.py'),
                               'dvats.encoder.fine_tune_mvp_train_': ('encoder.html#fine_tune_mvp_train_', 'dvats/encoder.py'),
                               'dvats.encoder.fine_tune_mvp_train_loop_step_': ( 'encoder.html#fine_tune_mvp_train_loop_step_',
                                                                                 'dvats/encoder.py'),
                               ...
                               'dvats.encoder.show_eval_stats_': ('encoder.html#show_eval_stats_', 'dvats/encoder.py'),
