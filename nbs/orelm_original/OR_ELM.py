...
# Comented by Inmaculada Santamaria-Valenzuela for easier understanding
# ----------------------------------------------------------------------
import numpy as np
from numpy.linalg import pinv
from numpy.linalg import inv
from nbs.orelm_original.FOS_ELM import FOSELM
...
class ORELM(object):
  def __init__(
    ...
    print("orelm-initialH ~ ", self.initial_H.shape)
